...
const Faq = () => {
  ...
  return (
    <motion.section
      ...
      className="mx-auto mt-[10vw] mb-[10vw] bg-white rounded-[2vw] w-[90vw] sm:w-[65vw] p-[5vw] sm:p-[2.5vw] shadow-lg"
    >
      <h2 className="sm:text-[2.8vw] text-[7.5vw] font-bold text-[#25272C] mb-[3.125vw]">
        Frequently Asked Questions
      </h2>

      <dl className="flex flex-col gap-[4vw] sm:gap-0">
        {faqData.map((item, index) => (
          <div key={index} className="mb-[3.125vw]">
            ...
            {open === index && (
              <dd className="mt-2 text-[3vw] sm:text-[1.125vw] font-light text-[#8E95A2] w-[90%] leading-[170%]">
                {item.answer}
              </dd>
            )}
          </div>
