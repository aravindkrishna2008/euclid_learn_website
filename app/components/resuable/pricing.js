  ...
  return (
    <div className="bg-[#3958F2] px-[6.25vw] py-[9.3vw] flex flex-col items-center justify-center">
      <div className="text-center">
        <h1 className="text-white text-[10vw] sm:text-[5vw] font-semibold leading-[120%] tracking-[-0.28px] text-center">
          Pricing Plans
        </h1>
        <p className="sm:text-[1.25vw] text-[4vw] font-light leading-[140%] mt-[4vw] sm:mt-0 sm:leading-[160%] text-white tracking-[0.0125vw] w-[80vw] sm:w-[51vw]">
