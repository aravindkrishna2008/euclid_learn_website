    ...
    <div className="relative bg-[#F5F7FA]">
      <div className="container mx-auto p-4">
        <div className="grid sm:grid-cols-2 gap-2 pb-[20vh]">
          ...
          <div className="flex flex-col sm:flex-row gap-[10vw]  rounded-[1.25vw]  ">
            <Image
              width={10000}
              height={10000}
          ...
          <div className="flex flex-col justify-center pb-[0.5vh] sm:mt-0 mt-[10vw] sm:ml-[10vw]">
          ...
          <div className="flex justify-center sm:hidden items-center mt-[5vh]">
            <Image
              width={10000}
              height={10000}
          ...
          <div className="flex flex-col justify-center sm:mt-0 mt-[10vw]  pt-[0.5vh]">
          ...
          <div className=" justify-center  hidden sm:flex items-center mt-[5vh]">
            <Image
              width={10000}
              height={10000}
              src="/stock_image/sat/sat2.jpeg"
