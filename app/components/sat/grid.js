      ...
      <div className="container mx-auto p-4">
        <div className="grid grid-cols-2 gap-2 pb-[20vh]">
          ...
          <div className="flex flex-col justify-center items-center pb-[0.5vh]">
            <p className="text-center sm:text-[48px] text-[10vw] font-semibold leading-[120%] ">
              We&apos;ll Meet You
            </p>
            <p className="text-center sm:text-[48px] text-[10vw] font-semibold leading-[120%]">
              Where You Are
          ...
          <div className="flex flex-col justify-center  pt-[0.5vh]">
            <p className="text-left sm:text-[48px] text-[10vw] font-semibold leading-[120%] tl-[30vh]">
              Stay Engaged and
            </p>
            <p className="text-left sm:text-[48px] text-[10vw] font-semibold leading-[120%]tl-[30vh] ">
              Accountable
