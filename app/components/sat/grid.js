    ...
    <section className="relative bg-[#F5F7FA]">
      <div className="container mx-auto p-4">
        <div className="grid sm:grid-cols-2 gap-2 pb-[20vh]">
          ...
          >
            <h2 className="sm:text-[3.75vw] sm:w-[30vw] text-[10vw] font-semibold leading-[120%]">
          ...
          >
            <Image
              ...
              alt="Stay engaged and accountable"
          ...
          >
            <h2 className="text-left sm:text-[3.75vw] sm:w-[30vw] text-[10vw] font-semibold leading-[120%] tl-[30vh]">
