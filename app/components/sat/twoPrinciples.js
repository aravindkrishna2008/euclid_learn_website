  ...
  return (
    <section className="bg-[#293CE7] pb-[30vw] py-[20vw] sm:pb-[20vw] relative sm:py-[10vw] flex flex-col items-center justify-center">
      ...
      <div className="flex gap-[1.25vw] flex-col sm:flex-row mt-[6.25vw]">
        <article className="flex flex-col bg-[#3958F2] rounded-[1.875vw] w-[80vw] sm:w-[28vw] py-[5vw] px-[5vw] sm:px-[2.5vw]">
          <Image
            width={10000}
            height={10000}
          ...
          <p className="sm:text-[1.25vw] text-[4vw] text-white font-light leading-[160%] tracking-[0.16px] mt-[1vw]">
            ...
            experience, so we develop syllabus according to their experience level.
          </p>
        </article>
        <article className="flex flex-col translate-y-0 sm:translate-y-[6.25vw] bg-[#3958F2] rounded-[1.875vw] w-[80vw] sm:w-[28vw] py-[5vw] px-[5vw] sm:px-[2.5vw]">
          <Image
            width={10000}
            height={10000}
          ...
          <p className="sm:text-[1.25vw] text-[4vw] text-white font-light leading-[160%] tracking-[0.16px] mt-[1vw]">
            We understand that mastering algorithmic programming requires regular
            practice and reflective learning. That is why, our course is structured
            in a way to ensure that students receive consistent practice.
          </p>
        </article>
      </div>
    </section>
