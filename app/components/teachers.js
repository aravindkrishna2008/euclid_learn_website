const Teachers = () => {
  return (
    <div className="bg-white flex flex-col items-center justify-center py-[10vw] px-[17vw]">
      <h1 className="text-[#25272C] font-semibold text-[5vw] leading-snug">
        Our Teachers
      </h1>
      <p className="text-[#25272C] font-light text-[1.25vw] mt-[1vw] text-center w-[50%]">
      ...
      <div className="flex flex-row gap-[1.25vw] mt-[5vw]">
        <div className="flex flex-col gap-[1.875vw] justify-center items-center  text-center">
          <img src="/Anirudh.png" />
          <div>
            <p className="text-[#5B616E] text-[1.4vw] font-semibold tracking-normal">
              Anirudh Shyam
            </p>
            <p className="text-[#8E95A2] font-light text-[1vw]">
        ...
        <div className="flex flex-col gap-[1.875vw] justify-center items-center  text-center">
          ...
          <div>
            ...
            <p className="text-[#8E95A2] font-light text-[1vw]">USAMO</p>
          </div>
        </div>
        <div className="flex flex-col gap-[1.875vw] justify-center items-center  text-center">
          <img src="/Abhinav.png" />
